...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String,ForgotPasswordRequestDto>forgotPasswordProducerFactory(){
        return new DefaultKafkaProducerFactory<>(dtoProducerConfig());
    }
    @Bean
    public KafkaTemplate<String,ForgotPasswordRequestDto> forgotPasswordKafkaTemplate(){
